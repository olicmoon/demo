...
public class CustomEngineDatabase {

    public final static String DBFILE = "test_custom_engine.db";
    ...
    public static final String TABLE_ABC = "custom_engine_table";
    public static final String TABLE_PQR = "custom_engine_table2";
    ...
    private class SensitiveDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase dbhdl) {
            ...
            try {
                ...
                executeSQLStatement(mDb, "CREATE TABLE custom_engine_table (id integer PRIMARY KEY AUTOINCREMENT, col1 text, col2 text, col3 text);");
                executeSQLStatement(mDb, "CREATE INDEX custom_idx ON custom_engine_table(col1);");

                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (1, 'custom_col1_text1', 'custom_col2_text1', 'plain');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (2, 'custom_col1_text2', 'custom_col2_text2', 'plain');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (3, 'custom_col1_text3', 'custom_col2_text3', 'plain');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (4, 'custom_col1_text4', 'custom_col2_text4', 'plain');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (5, 'custom_col1_text5', 'custom_col2_text5', 'plain');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table VALUES (6, 'custom_col1_text6', 'custom_col2_text6', 'plain');");


                executeSQLStatement(mDb, "CREATE TABLE custom_engine_table2 (id integer PRIMARY KEY AUTOINCREMENT, col1 text, col2 text);");
                executeSQLStatement(mDb, "CREATE INDEX custom_idx1 ON custom_engine_table2(col1);");

                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (1, 'custom_col1_text1', 'custom_col2_text1');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (2, 'custom_col1_text2', 'custom_col2_text2');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (3, 'custom_col1_text3', 'custom_col2_text3');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (4, 'custom_col1_text4', 'custom_col2_text4');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (5, 'custom_col1_text5', 'custom_col2_text5');");
                executeSQLStatement(mDb, "INSERT INTO custom_engine_table2 VALUES (6, 'custom_col1_text6', 'custom_col2_text6');");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS " + "custom_engine_table");
            db.execSQL("DROP TABLE IF EXISTS " + "custom_engine_table2");
            onCreate(db);
        }
    }

    public void deleteTables() {
        mDb.execSQL("DROP TABLE IF EXISTS " + "custom_engine_table");
        mDb.execSQL("DROP TABLE IF EXISTS " + "custom_engine_table2");
    }

    private String mEngineAlias = "";
    public CustomEngineDatabase(Context context, String alias) {
        mContext = context;
    ...
    public void setSensitive(String dbFileName) {
        ...
        try {
            SdpDatabase sdpColumn = new SdpDatabase(mEngineAlias);
            List<String> columnsList = new ArrayList<String>();
            columnsList.add("col1");
            columnsList.add("col2");
            sdpColumn.setSensitive(mDb, null, "custom_engine_table", columnsList);

            sdpColumn = new SdpDatabase(mEngineAlias);
            columnsList = new ArrayList<String>();
            columnsList.add("col1");
            sdpColumn.setSensitive(mDb, null, "custom_engine_table2", columnsList);
    ...
    public Cursor getDbRecords() {
        ...
        return db.query("custom_engine_table", null, null, null, null, null, null);
    }
